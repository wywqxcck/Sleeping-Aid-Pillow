...
{
 /*
    currentDataPoint.valueLamp = ;//Add Sensor Data Collection
    currentDataPoint.valueMassage = ;//Add Sensor Data Collection
    ...
    currentDataPoint.valueBlood_oxygen = ;//Add Sensor Data Collection
    currentDataPoint.valueSnoring = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    currentDataPoint.valueMassage = ;
    currentDataPoint.valueSleep = ;
    currentDataPoint.valuetemp = ;
    currentDataPoint.valuehumi = ;
    currentDataPoint.valueHeart_rate = ;
    currentDataPoint.valueBlood_oxygen = ;
    currentDataPoint.valueSnoring = ;
    */
